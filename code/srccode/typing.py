"""Type Specifications for the Srccode Framework.

This module contains type aliases for array types that are used throughout the Srccode framework.
...
"""
Type alias for the classes of array types supported by the Srccode framework.

This type alias includes the classes, not instances, of the array types that can be used within
the Srccode framework for RL and optimal control computations. 
...
"""
Type alias for the instances of array types supported by the Srccode framework.
