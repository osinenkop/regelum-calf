...
setup(
    name="rehydra-ax-sweeper",
    version=read_version("rehydra_plugins/rehydra_ax_sweeper", "__init__.py"),
    author="Omry Yadan, Shagun Sodhani",
    author_email="omry@fb.com, sshagunsodhani@gmail.com",
    description="Rehydra Ax Sweeper plugin",
    ...
    install_requires=[
        ...
        "ax-platform>=0.1.20,<0.2.1",  # https://github.com/facebookresearch/rehydra/issues/1767
        "torch",
