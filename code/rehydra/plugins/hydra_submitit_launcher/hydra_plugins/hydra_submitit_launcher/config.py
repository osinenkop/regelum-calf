...
class BaseQueueConf:
    ...
    submitit_folder: str = "${rehydra.sweep.dir}/.submitit/%j"
...
class SlurmQueueConf(BaseQueueConf):
    ...
    _target_: str = (
        "rehydra_plugins.rehydra_submitit_launcher.submitit_launcher.SlurmLauncher"
    )
...
class LocalQueueConf(BaseQueueConf):
    _target_: str = (
        "rehydra_plugins.rehydra_submitit_launcher.submitit_launcher.LocalLauncher"
    )
