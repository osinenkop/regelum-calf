...
Run this script with AWS admin credentials to create new integration test AMIs if any rehydra-core & rehydra-ray-launcher
...
def set_up_machine(cfg: DictConfig) -> None:
    ...
    with tempfile.NamedTemporaryFile(suffix=".yaml", delete=False) as f:
        ...
        os.chdir(rehydra.utils.get_original_cwd())
        _run_command(
