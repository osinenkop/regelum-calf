...
from rehydra._internal.grammar import grammar_functions
from rehydra._internal.grammar.functions import Functions
from rehydra.core.config_loader import ConfigLoader
from rehydra.core.override_parser.overrides_visitor import (
    RehydraErrorListener,
    RehydraOverrideVisitor,
)
from rehydra.core.override_parser.types import Override
from rehydra.errors import RehydraException, OverrideParseException

try:
    from rehydra.grammar.gen.OverrideLexer import (  # type: ignore[attr-defined]
        CommonTokenStream,
        InputStream,
        OverrideLexer,
    )
    from rehydra.grammar.gen.OverrideParser import OverrideParser
...
class OverridesParser:
    ...
    def parse_rule(self, s: str, rule_name: str) -> Any:
        error_listener = RehydraErrorListener()
        ...
        visitor = RehydraOverrideVisitor(self.functions)
        ...
        for override in overrides:
            try:
                ...
                raise OverrideParseException(
                    override=override,
                    message=f"{msg}"
                    f"\nSee https://rehydra.cc/docs/1.2/advanced/override_grammar/basic for details",
                ) from e.__cause__
