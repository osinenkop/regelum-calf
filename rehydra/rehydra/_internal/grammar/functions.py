...
from rehydra._internal.grammar.utils import is_type_matching
from rehydra.core.override_parser.types import QuotedString
...
class Functions:
    ...
    def register(self, name: str, func: Callable[..., Any]) -> None:
        if name in self.definitions:
            raise RehydraException(f"Function named '{name}' is already registered")
