...
class GridSamplerConfig(SamplerConfig):
    ...
    # search_space will be populated at run time based on rehydra.sweeper.params
    _partial_: bool = True
...
class OptunaSweeperConf:
    _target_: str = "rehydra_plugins.rehydra_optuna_sweeper.optuna_sweeper.OptunaSweeper"
