...
from srccode.utils import Clock, AwaitedParameter, calculate_value
...
from srccode.optimizable.core.configs import (
    TorchOptimizerConfig,
    CasadiOptimizerConfig,
)
from srccode.data_buffers.batch_sampler import RollingBatchSampler, EpisodicSampler
from copy import deepcopy
from typing_extensions import Self


class Scenario(SrccodeBase):
    ...
    def on_action_issued(self, observation):
        ...
        self.undiscounted_value += self.current_running_objective
...
class CALFScenario(RLScenario):
    def __init__(
        ...
        is_simple_eligibility_traces: bool = True,
    ):
        super().__init__(
            policy=policy,
            critic=critic,
        ...
        self.is_simple_eligibility_traces = is_simple_eligibility_traces
    ...
    def compute_action(
        ...
        if self.is_first_compute_action_call:
            ...
            if self.is_simple_eligibility_traces:
                ...
                self.weights_for_next_iteration = (
                    ...
                    / step_id
                    if critic_weights_accepted
                    else self.weights_for_next_iteration
                )
...
class CALF(CALFScenario):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            is_simple_eligibility_traces=is_simple_eligibility_traces,
        )
